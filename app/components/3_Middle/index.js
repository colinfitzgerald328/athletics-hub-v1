  ...
  return (
    <div className={styles.athleteBreakdown}>
        <div className={styles.itemsContainer}>
        {
          ...
          <Skeleton animation="wave" height={230} variant="rectangular"></Skeleton>
          :
        ...
        <div className={styles.athleteNameHolder}>
          {
            props.loadingNewAthlete ? 
            <Skeleton sx={{"zIndex": 1000}} animation="wave" variant="circular" width={150} height={150}></Skeleton>
            :
        ...
        <div className={styles.nameVariables}>
          {
            props.loadingNewAthlete ? 
            <Skeleton animation="wave" width={200} height={35} variant="rectangular"></Skeleton>
            :
            <div className={styles.fullName}>{props.athlete.full_name}</div>
          }
                    {
            props.loadingNewAthlete ? 
            <Skeleton sx={{"marginTop": "5px"}} animation="wave" width={300} height={35}></Skeleton>
            :
